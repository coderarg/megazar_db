...
##INSERTAR VALORES EN TABLA "clientes"
...
##INSERTAR VALORES EN TABLA "proveedores"
...
##INSERTAR VALORES EN TABLA "categorias"
...
INSERT INTO productos (id_producto, p_codigo, p_nombre, id_categoria, id_proveedor, stock) VALUES
('1', '8461', 'Lupa Plegable Luz 10 Led Manicura Pedicura Multifunción', '3', '6', 0),
('2', '5268', 'Pack 6 Velas Led Con Llama Con Movimiento Realistas (10cm)', '4', '18', 0),
('3', '5885', 'Set 10 Bowls Cocina Acero Inoxidable Ensaladera 21 Cm', '1', '17', 0),
('4', '3703', 'Cuchillo Hacha Hachuela Carnicero Chef Estilo Asiático', '1', '17', 0),
('5', '6272', 'Plato Rectangular Curvo Diseño Bandeja Picada Cerámica', '2', '8', 0),
('6', '6438', 'Set 6 Bandeja Rectangular Heladera Pollería Carnicería', '1', '3', 0),
('7', '6216', 'Tijera Para Peluquería Canina Esquilar Ovejas Animales', '3', '19', 0),
('8', '1579', 'Set 3 Cuchillos Acero Mas Pelapapa Filo Cerámico Regalo', '1', '18', 0),
('9', '6992', 'Set 100 Luces Led Lluvia Navidad Guirnalda Navideña A Pila', '4', '4', 0),
('10', '8601', '100 Luces Arroz Navidad Led Guirnalda X2 unidades', '4', '13', 0),
('11', '1541', 'Seca Limpia Vidrios Rasqueta Plástica Mango Corto ', '3', '15', 0),
('12', '5224', 'Chuchillo Navaja Mariposa Practica Sin Filo Tornasol', '5', '18', 0),
('13', '5338', 'Cafetera Prensa Francesa de Embolo Vidrio y Acero Inoxidable', '1', '15', 0),
('14', '6948', 'Cafetera Italiana Moka Expresso 3 Pocillos Aluminio Pulida', '1', '6', 0),
('15', '6821', 'Pinza Ferretería Artesano 4,5 Pulgadas Alicate', '3', '13', 0),
('16', '9998', 'Humidificador Difusor Usb Diseño Reno Hogar Turquesa', '4', '10', 0),
('17', '3892', 'Juego Llaves Torx Tramper 9 Piezas Largas', '3', '14', 0),
('18', '5038', 'Funda De Gel Para Asiento De Bicicleta Spinning Gel', '5', '9', 0),
('19', '6177', 'Mazo Poker Cartas Doradas Baraja Naipes Dolar', '7', '14', 0),
('20', '7089', 'Mochila Bolso Agua Hidratación Portátil Camping Ciclismo', '5', '12', 0),
('21', '8919', 'Kit Buceo Snorkel Pata Rana Antiparras Infantil', '5', '8', 0),
('22', '5037', 'Casco Reforzado Bici Roller Monopatin Colores Niños', '5', '6', 0),
('23', '3879', 'Botella Aluminio Deportiva 500ml Agua Gym Metalica', '5', '11', 0),
('24', '1348', 'Set Sushi X 4 Pzas Plato Cerámica Palito Chino Porta Salsa', '2', '4', 0),
('25', '3965', 'Set X 2 Aceitera Vinagrera Vidrio Pico Vertedor Tapa', '1', '18', 0),
('26', '3011', 'Budinera Molde Silicona Horno Repostería', '1', '15', 0),
('27', '3775', 'Set X10 Cubo Anti Stress Fidget Spinner Cube Ansiedad', '7', '20', 0),
('28', '9042', 'Set 8 Espatulas Uso Artístico Metálicas', '3', '10', 0),
('29', '3618', 'Kit Natación Gorro Gorra Silicona Antiparras', '5', '7', 0),
('30', '1821', 'Jenga 36 Piezas Madera Torre Apilable', '7', '9', 0),
('31', '8944', 'Soldaditos Plástico Bolsa X 45 Pzas', '7', '14', 0),
('32', '6176', 'Tijera Podar Curva 8 Pulgadas Jardinería', '3', '4', 0),
('33', '7634', 'Tabla De Picar Pleglable Flexible Cocina Verdura', '1', '12', 0),
('34', '2018', 'Set Cubiertos Tenedor Cuchara Navaja Camping', '5', '19', 0),
('35', '1698', 'Juego Domino 28 Piezas De Colores Estuche Metalico', '7', '12', 0),
('36', '3687', 'Pinza Multifunción Led 6 Funciones', '3', '4', 0),
('37', '2310', 'Pack 6 Velas Led Con Llama Con Movimiento Realistas (7.5cm)', '4', '8', 0),
('38', '4936', 'Pack 8 Velas Led Con Llama Con Movimiento Realistas (7.5cm)', '4', '12', 0),
('39', '5968', 'Cartuchera PowerRangers Rojo con Negro 25 cm', '6', '12', 0),
('40', '5747', 'Ajedrez Plegable Magnetico Tablero Pvc Imantado', '7', '12', 0);
...
#1 Realizar un Trigger con AFTER que modifique el stock cada vez que se realiza la venta o compra de un producto.
...
BEGIN
    ...
    SET cantidadProducto = NEW.com_cantidad;
    ...
    ##Registro en la tabla 'logs_compra_venta' USER() quien carga el producto, operacion: si es 'compra' o 'venta', id_compra y la fecha y hora actual.
...
##INSERTAR VALORES EN TABLA "compras"alter
...
#Verificamos que el stock de productos pasó de 0 a la cantidad comprada en cada caso.
...
BEGIN
    ...
    SET idProducto = NEW.id_producto;
    SET cantidadProducto = NEW.v_cantidad;
...
BEGIN
    ...
    SET existeCliente = (SELECT COUNT(*)
						FROM clientes
...
## Si ejecutamos este insert con un cliente no existente, el mismo se agrega al listado de clientes.
INSERT INTO clientes (c_cuit_cuil, c_nombres, c_apellidos, c_email, c_telefono, c_celular, c_direccion, c_provincia, c_pais, c_comentario, c_conversion, c_fecha_contacto ) VALUES
('21887722322', 'Fabiola', 'Fernandez', 'fabiccufernandez@gmail.com', '48381456', '1150625547', 'Independencia 466, Y4600AFJ San Salvador de Jujuy, Jujuy', 'Jujuy', 'Argentina', 'Lorem ipsum dolor sit amet consectetur', '0', '2022-06-11 17:48:09');
##Si volvemos a cargar el mismo cuit_cuil o email nos salta un error que de cliente existente.
INSERT INTO clientes (c_cuit_cuil, c_nombres, c_apellidos, c_email, c_telefono, c_celular, c_direccion, c_provincia, c_pais, c_comentario, c_conversion, c_fecha_contacto ) VALUES
('21887722322', 'Fabiola', 'Fernandez', 'fabiccufernandez@gmail.com', '48381456', '1150625547', 'Independencia 466, Y4600AFJ San Salvador de Jujuy, Jujuy', 'Jujuy', 'Argentina', 'Lorem ipsum dolor sit amet consectetur', '0', '2022-06-11 17:48:09');

#Si vemos en la tabla de log_megazar, observamos los cambios realizados por el usuario, el tipo de cambio ("nuevo_cliente"), id del cliente y fecha y hora de ejecución del comando.
select * from log_megazar;
